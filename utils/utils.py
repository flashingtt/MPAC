...
from dataset.data_utils import CIRRDataset, FashionIQDataset
...
def extract_index_features(args, dataset: Union[CIRRDataset, FashionIQDataset], model) -> \
    ...
    classic_val_loader = DataLoader(dataset=dataset, batch_size=32, num_workers=args.num_workers,
    ...
    for names, images in tqdm(classic_val_loader):
        ...
        with torch.no_grad():
            ...
            if args.asynchronous:
                ...
                tar_batchfeats = model.image_encoder(images.type(model.dtype), tar_shared_ctx, tar_deep_compound_prompts_vision)
